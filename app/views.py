...
def predict_image_CT(request):
    ...
    if context['predicted_class']=='Cancer':
        ...
        while context_3['confidence']<80:
            context_3 = predict_image(request, model, class_name)
        final_class = {'file_path_name':context['file_path_name'],'predicted_class':context['predicted_class']+ "avec une grand possibiliter d'etre de type "+context_3['predicted_class']}
